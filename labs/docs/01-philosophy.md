...
The strongest argument *for* this shape, from lived reality: on these apps today, many undetectable people already write "on PrEP" in their bios — a coerced lie that erases their status to pass. A shared, honest top that an undetectable person reaches **indistinguishably from PrEP users** replaces that lie with truthful equality. That is the most pro-U=U thing the product does.
