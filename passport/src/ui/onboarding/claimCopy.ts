...
export const COPY = {
  ...
  recoverPwLabel: "Use your handle and password",
  recoverPwHint:
    "If you set one up, sign in with your handle and password instead of the phrase.",
  recoverPwNameLabel: "Your handle",
  recoverPwNameHint: "The @name you set your password up with.",
