...
export const COPY = {
  ...
  trustLive: [
    ...
    "Lose your device? Make the link private from Privacy & sharing and the live pass becomes gray.",
  ],
  trustQr: [
    ...
    "Lose your device? Rotate the link from Privacy & sharing and the code stops working.",
  ],
} as const;
