...
const COPY = {
  ...
  nameUnavailable: "That recovery name is taken. Try another one.",
  weak: "Pick a stronger password.",
  failed: "Couldn't set it up. Try again.",
  onLead: "Get back in on a new device with your recovery name and password.",
  yourName: "Your recovery name",
